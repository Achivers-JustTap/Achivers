...
const RcFileChange = ({ navigation }) => {
  ...
  const proceedToNext = () => {
    ...
    navigation.navigate('RC_List', { RC,rcFrontFile,rcBackFile,uploadSuccess: true}); // Replace 'NextScreen' with the actual next screen name
  };
